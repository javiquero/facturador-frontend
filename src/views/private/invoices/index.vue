                            ...
                            <v-list>
                                <v-list-item-group active-class="white" >
                                    <v-list-item >
                                         ...
                                         <v-list-item-content><v-list-item-title >Importar facturas</v-list-item-title>    </v-list-item-content>                                                                            
                                    </v-list-item>
                                    <v-list-item >
                                         <v-list-item-icon><i class="fal fa-fw fa-sync"></i></v-list-item-icon>
                                         <v-list-item-content><v-list-item-title >Actualizar facturas</v-list-item-title>    </v-list-item-content>                                                                            
                                    </v-list-item>
                                     <v-divider></v-divider>
                                      <v-list-item >
        ...
        <v-row class="">
            <v-col cols="12">
                <v-card color="white" elevation="2">
                    <v-card-text>
                        <v-data-table :headers="computedHeaders" :footer-props="{itemsPerPageOptions: [50,100,500,-1]}" :items="data" multi-sort :search="filter" show-select :items-per-page="100" class="elevation-1">
